...
export const skills = [
  ...
  { name: "SQL (Basic SQL)", description: "Queries, joins, aggregation", level: 78 },
  { name: "Linux", description: "CLI workflows and tooling", level: 76 },
  { name: "Docker", description: "Containerization and images", level: 78 },
  { name: "Version Control (GitHub)", description: "Git branching and PRs", level: 85 },
  { name: "UI/UX Figma", description: "Wireframes and prototypes", level: 74 },
  {
    name: "DevOps (Kubernetes, Ansible, Jenkins, GitLab, DigitalOcean)",
